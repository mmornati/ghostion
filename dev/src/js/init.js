(function ($) {
    ...
    $(document).ready(function(){
        ...
        $("#at_body").wrap( "<div class='off-canvas-wrap' data-offcanvas><div class='inner-wrap'></div></div>" ).append("<a class='at_off_canvas_toggle left-off-canvas-toggle'><span class='fa fa-bars'></span></a><a class='exit-off-canvas'></a>");
